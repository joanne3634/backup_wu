...
//            System.out.println(responseTxt + "******");
            ...
            logger.info("payment return call:orderNo={}, response={}", order_no, responseTxt);
            String verifyStatus = "";
            ...
            if (mysign.equals(sign) && responseTxt.equals("true")) {
                ...
                if (trade_status.equals("TRADE_FINISHED")) {
                    ...
                    if ("3".equals(tmoneymove.getTypeId())) {
                        ...
                        TUser tuser = tuserService.getById(tmoneymove.getUserId());
            ...
            logger.error("payment call back error", e);
            e.printStackTrace();
        }

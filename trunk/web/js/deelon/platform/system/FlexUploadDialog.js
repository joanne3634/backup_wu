...
function DirectUploadDialog(b) {
	if (!b) {
		b = {};
	}
	var a = __ctx + "/platform/system/sysFile/uploadDialog.ht";
	a = a.getNewUrl();
	var c = window;
...
function UploadDialog(c) {
	...
	var b = __ctx + "/platform/system/sysFile/uploadDialog.ht";

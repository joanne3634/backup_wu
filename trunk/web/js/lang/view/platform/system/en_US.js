var $lang_system = {
	...
	globalType : {
		...
		sortList : {
			success_msg : 'Sort By complete!',
			error_msg : 'Sort classification fails'
		},
		upd1 : {
	...
	sysTypeKey : {
		list : {
			warn_msg_add_no_sort : 'no sort operation, select OK to sort!',
	...
	resources : {
		addResource : {
			warn_msg_no_parent : 'Please select from the left resource tree parent node! ',
			warn_msg_column_parent : 'Select the parent node of the node must be part! ',
			success_msg : 'Add to menus success! ',
			error_msg : 'Add to menus success! '
		}
	},
	subSystem : {
		import_ : {

...
var domUtils = dom.domUtils = {
    ...
    findEditableInput: function(child){
    	var span = domUtils.findParentByTagName(child,'span',false,function(node){
			if(node.getAttribute("name") !="editable-input")return true;
		});
		if(span)return span;
		return child;
    }

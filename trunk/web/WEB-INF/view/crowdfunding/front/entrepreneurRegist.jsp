            ...
            $.ajax({
                ...
                success: function (data, textStatus) {
                    if (data == "0") {
                        ...
                        //setTimeout('window.location = "${ctx}/user/registerInit.ht?type=1";',2000);
                    }
...
<div class="window">
    ...
    <form id="register_form">
        ...
        <div class="InReform">
            <ul><input type="hidden" name="groupId" value="1"/>
                <input type="hidden" value="0" name="isCompany"/>
                <li><em><label class="red">*</label>用户名： </em><input type="text" id="loginName" name="loginName"
                                                                     onblur="copyLoginName_remarks(this.value)"/></li>
                <li><em><label class="red">*</label>邮箱：</em><input type="text" id="email" name="email"/></li>
                <li> <%--<em id="remarks_"><label class="red">*</label>个人说明：</em>--%>
                    <input type="hidden" class="explain" id="remarks" name="remarks"/>
                </li>
                <%--	<li class="explainLi"><em>&nbsp;</em><span>个人说明建议采用公司+职务+真实姓名</span></li>--%>
                <li><em> <label class="red">*</label>密码： </em><input type="password" id="loginPwd" name="loginPwd"
                                                                     onKeyUp="pwStrength(this.value)"
                                                                     onBlur="pwStrength(this.value)"/></li>
                <li class="explainLi"><em>&nbsp;</em><dfn>
                    <table width="150" border="1" cellspacing="0" cellpadding="1" bordercolor="#eeeeee" height="16"
                           style='display:table;font-size:12px;position: relative;top:1px;left:120px;z-index: 100;line-height: 16px;float: left;'>
                ...
                <li><em><label class="red">*</label>确认密码：</em><input type="password" id="resloginPwd"
                                                                     name="resloginPwd"/></li>
                <li><em id="xingming_"><label class="red">*</label>真实姓名：</em><input lang="xingming_" type="text"
                                                                                    id="realName"
                                                                                    name="realName"/><span>用于网站运营管理人员替您办理投融资手续时使用</span>
                </li>
                <li><em id="shenfenzheng_"><label class="red">*</label>身份证号：</em><input lang="shenfenzheng_" type="text"
                                                                                        id="idNo" name="idNo"/><span>用于网站运营管理人员替您办理投融资手续时使用</span>
                </li>
                <li><em><label class="red">*</label>个人住址：</em><input type="text" id="personalAddress"
                                                                     name="personalAddress"/><span>用于办理投资入股工商变更手续及快递接收</span>
                </li>
                <li><em><label class="red">*</label>手机号码：</em><input type="text" id="mobile" name="mobile"/><span>用于网站运营管理人员替您办理投融资手续时使用</span>
                </li>
                <li><em><label class="red">*</label>验证码：</em><input type="text" placeholder=" " class="code" id="code"
                                                                    name="code"/><img src="${ctx}/servlet/ValidCode"
                                                                                      id="validImg" alt=""
                                                                                      onclick="reload()"
                                                                                      style="cursor: pointer;"/></li>
                <li class="agreement"><em></em><input type="checkbox" name="Usertype" checked="checked"/><a
                        style="color: red;" target="_blank" href="${ctx }/loan/aboutus/TermsServiceList.ht?xieyiid=4">我已阅读并认可众筹《注册协议》</a>
                </li>
                <li><em>&nbsp;</em><dfn class="InReformButton" id="InReformButton" onclick="register_form_submit();"
                                        style="cursor: pointer;">立即注册</dfn></li>
            </ul>
        </div>
    </form>
</div>

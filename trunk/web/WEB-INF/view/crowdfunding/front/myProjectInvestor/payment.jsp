...
<style type="text/css"> 
.box{
	width:896px; height:396px; background:url(${ctx }/bkImages/wuyouchou_top.jpg) no-repeat; border-collapse:collapse;
...
<body>
		...
		<form id="rongpaysubmit" name="rongpaysubmit" action="${ctx }/crowdfunding/front/tcprojectinvest/toRoonpay.ht" method="post" >
  ...
  <tr>
              ...
              <tr>
                <td align="center"><table width="80%" border="0" cellspacing="0" cellpadding="0" style="padding:5px; margin-top:50px;">
                    <TR>
                      ...
                      <TD style="padding:5px;"><INPUT  maxlength="200" width="400px;" readonly="readonly" value="${project.pname}"></TD>
                    </TR>
                    <tr>
                      <td height="40" align="right">付款用途：</td>
                      <td style="padding:5px;"><input type="text" readonly="readonly"  value="项目认投"/></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="40" align="right">认投金额:</td>
                      <td style="padding:5px;"><input type="text" readonly="readonly"  value="${ivest.piinvest}"  />万</td>
                      <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="padding:5px;">    	
                   		 <input type="button" onclick="sufun()"   style="width:130px;background-image: url(${ctx }/bkImages/qrzfk.gif)" value="" >
                        </td>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
   ...
   <input type="hidden" id="investId" name="investId" value="${investId }"/>  
	...
	function setvalueFun(n){
		...
		$("#radioRecheck").val("defaultbank"+n);
		
	}
	function setvalueFunB2b(n){
		var defaultbank=$("#defaultbankB2b"+n).val();
		$("#defaultbank").val(defaultbank);
		$("#radioRecheck").val("defaultbankB2b"+n);

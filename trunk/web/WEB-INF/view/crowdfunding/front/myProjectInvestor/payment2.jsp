            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center"><table width="80%" border="0" cellspacing="0" cellpadding="0" style="padding:5px; margin-top:50px;">
                    <TR>
                      <TD height="40" align="right">支付名称： </TD>
                      <TD style="padding:5px;"><INPUT  maxlength="200" width="400px;" readonly="readonly" value="支付项目认筹诚意金"></TD>
                    </TR>
                    <tr>
                      <td height="40" align="right">付款用途：</td>
                      <td style="padding:5px;"><input type="text" readonly="readonly"  value="认筹诚意金"/></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="40" align="right">认筹诚意金:</td>
                      <td style="padding:5px;"><input type="text" readonly="readonly"  value="${pinvestAmount}" readonly=true />元</td>
                      <td>&nbsp;</td>
                    </tr>
                   ...
                   <!--   <tr>
                      ...
                      <td style="padding:5px;">
                        <input type="radio" id="yesorno" name="yesorno" onClick="on_hide();"/>是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" id="yesorno" name="yesorno" value="No" checked onClick="on_hide();"/>否
                    ...
                    <tr>
                      <td height="40">&nbsp;</td>
                      <td style="padding:5px;">    	
                        <%-- <INPUT TYPE=image NAME="SUB" src="${ctx }/bkImages/qrzfk.gif"> --%>
                       ${sHtmlText }
                        </td>
                      <td>&nbsp;</td>
                    </tr>

							...
							<div class="PrHiDataList">
								<form >
									<ul>
										...
										<li><span>5、阶段收入： </span><input type="radio" name="income" value="0"/>有<input type="radio" name="income"  checked="checked" value="1"/>无 
											<div class="InPrlistTable"  style="display:none"> 
										...
										<li><span>6、阶段开支：  </span> <input type="radio" name="outcome"  value="0"/>有<input type="radio" name="outcome" checked="checked" value="1"/>无
											<div class="InPrlistTable" style="display:none"> 

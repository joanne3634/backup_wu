		...
		<form id="tuserAuditForm" method="post" action="save.ht">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<th width="10%">所在城市:</th>	
								<td>										 
									<f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${tuserAudit.provincesId }"/>
									<f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${tuserAudit.cityId }"/>
								</td>
								<th width="10%">个人地址:</th>	
								<td>

	...
	if(agOrdisag=='agree'){
		...
		$.ligerDialog.confirm("确认执行该操作吗？","提示信息",function(rtn){
			if(!rtn){
				...
				var rep=$.ajax({  
			        type: "POST",  
			        url: "${ctx}/crowdfunding/backstage/toAuditProject/updates.ht",
...
function recommandProject(isrecomm){

	var checkboxList = $("input[type='checkbox'][class='pk']:checked");
	...
	ids = ids.substring(0, ids.lastIndexOf(","));
	 ...
	 var rep=$.ajax({  
	        ...
	        data: {applyIds:ids,isrecomm:isrecomm }  
	        });  
		rep.done(function( data ){  
			 $.ligerDialog.success(data.msg,"提示信息",function(rtn){
			 window.location.href="list.ht";
			 })
	        });  
	      
	    rep.fail(function( jqXHR, textStatus ) {  
	        $.ligerDialog.warn(textStatus,"提示信息",function(rtn){
	        	window.location.href="list.ht";
	        });
	    });
}
				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><f:a alias="recommand_tproject" css="link lock" href="javascript:void(0);" onclick="recommandProject('0')"><span></span>项目推荐</f:a></div>
							<div class="l-bar-separator"></div>
							<div class="group"><f:a alias="unrecommand_tproject" css="link lock" href="javascript:void(0);" onclick="recommandProject('1')"><span></span>取消推荐</f:a></div>
				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="tprojectList" id="tprojectItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
							...
							<display:column property="realName" title="创业者" sortable="false" sortName="realName" style="text-align:left;;width:8%;"/> 
							...
							<display:column title="认投金<br/>额(万元)" sortable="false" sortName="pinvestAmount" style="text-align:left;;width:8%;">
								<fmt:formatNumber value="${tprojectItem.pinvestAmount/10000 }" pattern="###,###.##"  minFractionDigits="0"  ></fmt:formatNumber>
							</display:column> 
							 <display:column property="pcomplete" title="完成比例%" sortable="false" sortName="pcomplete" style="text-align:left;width:5%;">
							...
							<display:column property="pinvestCount" title="跟投人数" sortable="false" sortName="pinvestCount" style="text-align:left;width:5%;"/> 

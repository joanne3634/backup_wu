...
<script type="text/javascript" src="${ctx}/js/deelon/formdata.js"></script>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/AddResourceDialog.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/BpmDefinitionDialog.js"></script>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/DataTemplateEdit.js"></script>
</head>
<body>
<div class="panel">

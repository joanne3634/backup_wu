<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.deelon.platform.model.system.SysUser"%>
...
<c:set var="SysUser_UN_LOCKED" value="<%=SysUser.UN_LOCKED %>"/>
	<div class="panel">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.ht">
						<ul class="row">
							...
							<div class="row_date">
							<li><span class="label">创建时间从:</span><input type="text" id="Q_begincreatetime_DL" name="Q_begincreatetime_DL"  class="inputText date" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'Q_endcreatetime_DG\');}'})" value="${param['Q_begincreatetime_DL']}"/></li>
							<li><span class="label">至</span><input type="text" id="Q_endcreatetime_DG" name="Q_endcreatetime_DG"  class="inputText date" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'Q_begincreatetime_DL\');}'})"  value="${param['Q_endcreatetime_DG']}"/></li>
							</div>
		...
		<div class="panel-body">
				...
				<deelon:paging tableId="sysUserItem"/>

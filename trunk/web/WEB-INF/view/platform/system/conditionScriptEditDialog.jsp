...
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/RuleDialog.js" ></script>
<script type="text/javascript" src="${ctx}/js/javacode/codemirror.js"></script>
<script type="text/javascript"src="${ctx}/js/deelon/platform/system/ConditionScriptAddDialog.js"></script>
<script type="text/javascript"src="${ctx}/js/deelon/platform/system/ConditionScriptDialog.js"></script>

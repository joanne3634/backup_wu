	...
	<script type="text/javascript">
		$(function() {
			...
			$("#mailAddress").blur(function(){
				var SSLChecked = $('#SSLCheckBox').attr('checked')=='checked' ;
			...
			$("#testConnect").click(function(){
				...
				smtpPort:smtpPort,popHost:popHost,popPort:popPort,imapHost:imapHost,imapPort:imapPort,mailType:type,SSL:SSL},function(data){
				...
				<form id="outMailUserSetingForm" method="post" action="save.ht">
					...
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td>
								<input type="checkbox" id="SSLCheckBox"/>
								<input type="hidden" name="SSL" id="SSL" value='<c:out value="${outMailUserSeting.SSL}" default="0"/>' />
							</td>
						</tr>
						<tr>

						...
						<tr>
							...
							<td>
			                    ...
			                    <select id="FCityId" name="FCityId" style="width:100px;">
			                    	<option value="${tuserFamily.FCityId }"><f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${tuserFamily.FCityId }"/></option>
			                    </select>
			                    <select id="FAreaId" name="FAreaId" style="width:100px;">
			                    	<option value="${tuserFamily.FAreaId }"><f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${tuserFamily.FAreaId }"/></option>
			                    </select>

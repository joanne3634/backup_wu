...
<head>
	...
	<script type="text/javascript">
		$(function() {
			valid(showRequest,showResponse,0);
		});
		...
		<form id="tbankForm" method="post" action="save.ht">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<th width="25%"> 银行代码:</th>	
								<td>										 
									<input type="text" id="bankCode" name="bankCode" value="${tbank.bankCode}" class="inputText" /><span style="color: red">*(请用大些字母)</span>
								</td>
							</tr>
							<tr>
								<th width="25%"> 支持投资机构付款:</th>	
								<td>			
									<f:select nodeKey="sf" id="isCompanyPay" defaultValue="${tbank.isCompanyPay}" showBlankOnTop="true" name="isCompanyPay" />						 
								</td>
							</tr>
							<tr>
								<th width="25%"> 银行图片:</th>	

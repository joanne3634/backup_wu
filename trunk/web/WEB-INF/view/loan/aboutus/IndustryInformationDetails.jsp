...
<!DOCTYPE html> 
  ...
  <link rel="stylesheet" href="${ctx }/styles/p2p/Skin/Default/css/public.css">
    <link rel="stylesheet" href="${ctx }/styles/p2p/Skin/Default/IndustryInformationDetails.css"> 
	...
	#bodyright{
	 width:831.5px;
      ...
      <div id="bodyright" class="bodyRightBorder">
        ...
        <div>发布时间：<div><fmt:formatDate value="${cms.contentCreateDate}" pattern="yyyy-MM-dd HH:mm"/></div>来源：<div>${cms.contentAuthor}</div></div>
      ${cms.contentText}      </div>
    </div> 
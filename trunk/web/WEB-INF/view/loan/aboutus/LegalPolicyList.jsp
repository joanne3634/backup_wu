...
<head>
	<meta charset="UTF-8">
		<title><%=application.getAttribute("PLATFORM_NAME")%> - 法律政策</title>
...
<body   > 
  ...
  <div class="container">
    <div class="weizhi-lianjie">
     <a href="${ctx }/index-web.jsp">首页</a> > <span>法律政策</span>
    </div> 
   
     <div id="body"> 
      <div id="legalpolicy-body">
        <div class="tit-box element-box bg-color-s bd-color-main"><span class="shuxian bd-color-shuxian"></span><span class="tit-xl color-main" id="title">法律政策</span></div>

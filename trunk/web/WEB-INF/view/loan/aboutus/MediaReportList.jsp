...
<link rel="stylesheet"
	href="${ctx }/styles/p2p/Skin/Default/MediaReportList.css">

<div class="con">
	<ul>
		<c:forEach items="${cms}" var="cms">
			<li><pageTag:TraversalFileId menupath="${cms.contentFileIds}" />
				<div>
					<a
						href="${ctx}/site/MediaReport/MediaReportDetails.ht?id=${cms.siteMenuContentId}"><h2>${cms.contentTitle
							}</h2></a>
					<p class="mediaReport-p">${cms.contentSummary}</p>
					<span>

...
<!-- 										</select> -->
									...
									<dd class="select-box">
					                    ...
					                    <select id="FCityId" name="FCityId" style="width:100px;">
					                    	<option value="${userFamily.FCityId }"><f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${userFamily.FCityId }"/></option>
					                    </select>
					                    <select id="FAreaId" name="FAreaId" style="width:100px;">
					                    	<option value="${userFamily.FAreaId }"><f:description modelCode="t_area"  modelPropertyName="areaName" modelPropertyValue="id" nodeKey="MODEL_DATA"  itemValue="${userFamily.FAreaId }"/></option>
					                    </select>

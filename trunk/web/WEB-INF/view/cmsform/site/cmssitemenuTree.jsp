...
<script type="text/javascript">
	...
	function entityClick(event, treeId, treeNode, clickFlag) {
		...
		commonTree = new com.deelon.form.commonTree({
			treeName:"menuTree",
			listFrame:"listFrame",
			addOrEditNodeUrl:"/cmsform/site/cmssitemenu/edit.ht?siteConfigId="+siteConfigId,
			delNodeUrl:"/cmsform/site/cmssitemenu/del.ht",
			...
			setting:{
				...
				data: {
					...
					key: {name: "menuName",nameArr:"siteMenuId"}
				},
				callback:{},
				view: {
					selectedMulti: false
...
<div id="layout">
	<div position="left" title="站点名称" >
		<div style="width:100%;">
		 <input class="entityComBo" entityCode="CmsSiteConfig" d readonly="readonly" entityFiledId="siteConfigId" entityFiledName="siteName" 

...
(function ($)
{
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                g.left = $("> div[position=left]", g.layout).wrap('<div class="l-layout-left" style="left:0px,top:30px;"></div>').parent();
        ...
        _bulid: function ()
        {
            ...
            if (g.top)
            {
                ...
                if(g.top.css('borderTopWidth')){
                	var borderTopWidth=parseInt(g.top.css('borderTopWidth'));
                	if(!isNaN(borderTopWidth)){
                		g.middleTop += parseInt(g.top.css('borderTopWidth'));
                	}
                }
                if(g.top.css('borderBottomWidth')){
                	var borderBottomWidth=parseInt(g.top.css('borderBottomWidth'));

...
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/ScriptDialog.js" ></script>
<script type="text/javascript" src="${ctx}/js/jquery/plugins/jquery.qtip.js" ></script>
<script type="text/javascript" src="${ctx}/js/util/easyTemplate.js" ></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/FormUtil.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/BpmDefinitionConditionEdit.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/BpmNodeRule.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/ConditionScriptEditDialog.js"></script>
<script type="text/javascript"src="${ctx}/js/deelon/platform/system/PersonScriptAddDialog.js"></script>

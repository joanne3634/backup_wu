...
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/TemplateDialog.js"></script>
		...
		*/
		function generateExpress(obj){
			...
			case 'number':
				...
				break;
			case 'date':
				flowVarValue = "com.deelon.core.util.TimeUtil.convertString(\""+flowVarValue+'\","yyyy-MM-dd HH:mm:ss")';
				switch(flowVarOperate){
				case "eq":

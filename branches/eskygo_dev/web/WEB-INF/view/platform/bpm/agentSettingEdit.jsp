		...
		*/
		function validateComplictAgainstGeneral(){
			...
			$.ajax({
				...
				rtn.status = -1;
				rtn.msg=$lang_bpm.agent.settingEdit.serverError;
			});
			return rtn;
		}
		/**
...
<div class="panel">
	...
	<div class="panel-body">
			...
			<div id="bpmAgent"  <c:if test="${agentSetting.authtype==0 or agentSetting.authtype==2}"> style="display: none"</c:if> >
				<div class="panel-top">
					<div class="tbar-title">
						<span class="tbar-label"><spr:message code="agentSetting.edit.authFlow"/></span>
					</div>
					<div class="panel-toolbar">
						<div class="toolBar">
							<div class="group">
...
<textarea id="tableRowTemplate" style="display: none;">
	<tr id="def_#defKey"}" type="subdata">
			...
			<td>
				<a href="#" class="link del" onclick="singleDel(this);"><spr:message code="operator.del"/></a>
			</td>
	</tr>
</textarea>

...
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/SubRightsTree.js"></script>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/SubRights.js"></script>

...
<%--     <link href="${ctx}/js/desktop/inettuts.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="${ctx}/js/deelon/platform/desktop/desktopShow.js" ></script>
    <script type="text/javascript" src="${ctx}/js/deelon/platform/desktop/desktopTemplete.js" ></script>
	<script type="text/javascript">
		...
		function save(){
			...
			com.deelon.platform.desktop.saveCol(layoutID,"desktopMycolumn",layoutCols);
		}
		$(function () { 
			var desktop="${desktop}";
			...
			new com.deelon.platform.desktop.myTemp(cols,columnId,width,1,desktop);

...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx }/js/deelon/platform/scheduler/JobDialog.js"></script>
		<script type="text/javascript" src="${ctx }/js/deelon/platform/scheduler/Trigger.js"></script>

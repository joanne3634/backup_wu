...
<head>
	...
	<link rel="stylesheet" href="${ctx}/crowdfunding/resources/css/securityQuestion.css?&_cache=0" type="text/css">
</head>
<body id="securityQuestion" class="iframe">
<form id="questionForm" method="post">
		<div id="securityQuestion" class="all-100 push-center addyourproject addyourproject f_l">
		<div class="title">
			<h3><i class="fa fa-exclamation"></i>安全问题</h3>
		</div>
        <div class="con-box content">
          <div class="tips">>>安全问题是基础安全工具，可作为二次验证的备选方案，建议认真填写。</div>
          <dl>
            <dt></dt>
          ...
          <div style="text-align:center;">
            <input id="sub-btn-jibenxinxi" class="ink-button blue" type="button" value="确认提交" onclick="fillSafeQuestion()"/>

...
<%
	String projectId =RequestUtil.getString(request, "projectId") ; // 附件分类编号
	String investId =RequestUtil.getString(request, "investId") ; // 附件分类编号
...
<html>
  ...
  <style type="text/css"> 
	...
	#flashContent { display:none; }
       ...
       var uploadPath="${ctx}/crowdfunding/front/tcprojectinvest/uploadSurveyFileUpload.ht;jsessionid=<%=session.getId()%>?investId=${investId}";
       var delPath="${ctx}/crowdfunding/front/tcprojectinvest/uploadSurveyAttachDel.ht;jsessionid=<%=session.getId()%>" ;
       var fileExt="document@*.doc;*.docx#images@*.jpg;*.png,*.gif,*,*.txt,*,*.xls";

	...
	<div class="panel">
				...
				<div class="panel-body">
					<div class="panel-search">
						<form id="searchForm" method="post" action="listUpd.ht">
							<div class="row">
					...
					<div class="panel-data">
					    ...
					    <display:table name="tprojectList" id="tprojectItem" requestURI="listUpd.html" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="项目名称" sortable="false" sortName="pname" style="text-align:left"> 
								<a title="点击修改项目" href="${ctx}/crowdfunding/backstage/proAudit/upd.ht?projectId=${tprojectItem.projectId}" >${tprojectItem.pname }</a>
							 </display:column>

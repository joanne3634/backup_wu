			...
			if(StringUtil.isEmpty(projectId)){
				...
				if(null!=lists&&lists.size()>0){
					...
					//	if("7".endsWith(project.getPstateId())||"1".endsWith(project.getPstateId())||"2".endsWith(project.getPstateId())||"3".endsWith(project.getPstateId())){
						if("2".endsWith(project.getPstateId())||"9".endsWith(project.getPstateId())||"0".endsWith(project.getPstateId())||"1".endsWith(project.getPstateId())||"3".endsWith(project.getPstateId())){
							if(Long.valueOf(projectId).compareTo(project.getProjectId())<0){
								projectId = project.getProjectId()+"";
								tcproject = project;
							}
							String cityName = project.getPcityIname();

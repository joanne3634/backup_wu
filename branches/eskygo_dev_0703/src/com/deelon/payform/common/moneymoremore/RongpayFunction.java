...
import com.deelon.payform.util.moneymoremore.Md5Encrypt;
...
public class RongpayFunction {
	private static final Logger LOGGER = LoggerFactory.getLogger(RongpayFunction.class);
	...
	public static String BuildMysign(Map sArray, String key) {
		if(sArray!=null && sArray.size()>0){
			...
			String md5Str = prestr.append(key).toString();
			LOGGER.info("payment call back parameters = {}",md5Str);
			return Md5Encrypt.md5(md5Str);//把拼接后的字符串再与安全校验码直接连接起来,并且生成加密串
		}
		return null;
	}

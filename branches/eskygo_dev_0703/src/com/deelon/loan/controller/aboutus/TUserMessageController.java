...
public class TUserMessageController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		return new ModelAndView("/loan/aboutus/TUserMessageList.jsp")
	...
	public ModelAndView LeaveMessage(HttpServletRequest request)
			throws Exception {
		return new ModelAndView("loan/aboutus/LeaveMessage.jsp");
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		this.Update(tuserMessage);//更新留言查看状态
		TUser user = this.getUserAll(tuserMessage.getUserId());
		return new ModelAndView("loan/aboutus/TUserMessageGet.jsp").addObject(
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		TUser user = this.getUserAll(tuserMessage.getUserId());
		this.Update(tuserMessage);//更新留言查看状态
		return new ModelAndView("loan/aboutus/TUserMessageReply.jsp")
	...
	public void Replysave(HttpServletRequest request,
    	...
    	tuserMsgremind.setSenderId(Long.parseLong(String.valueOf(creator)));
    	tuserMsgremind.setContent(tuserMessage.getMessageReplyAbout());
    	tuserMsgremind.setReceiverId(tuserMessage.getUserId());
	...
	public ModelAndView CheckTheRecords(HttpServletRequest request, HttpServletResponse response)
		...
		List<TUserMessage>  list = tusermessageService.getBySqlKeyAll(filter, TUserMessage.class, "getUserId");
		 request.setAttribute( "page_bean", pb );
		return new ModelAndView("/loan/aboutus/CheckTheRecords.jsp").addObject("list",list).addObject( "page_bean", pb );
	}
	...
	public ModelAndView CheckTheRecordsDetails(HttpServletRequest request, HttpServletResponse response)
		...
		return new ModelAndView("/loan/aboutus/CheckTheRecordsDetails.jsp").addObject("tuserMessage",list);
	}

...
public class CreateAuthUrl {
	 ...
	 */
	public static String strDefaultKey = "11111111111111";
	...
	public static String Decode(String str) {
		...
		i2 = DECRYPT(strDefaultKey.getBytes(), byteMingW, byteMiW,
				byteMiW.length);
	...
	public static void main(String[] args){
		String urlStr="http://121.40.136.150:8080/IdInDataAu/api/authenInfoApi.htm";
		String userId="100102";
		String ts =System.currentTimeMillis()+"";
		String orderNo =ts;
		String mKey="H55RW1599leZw3D9Lc3QJ73337IFuU51";//MD5密钥
		String dateString ="";
		String name="李静";
		String idCode="420621199311214211";
		strDefaultKey="3ElVCA1CKx7X79s5a3K7C9eyDb1b5q1t";//DES密钥
		try {
...
//			dateString=URLEncoder.encode(dateString,"GBK");
		...
		String nameDes=Encode(name);
		String idCodeDes=Encode(idCode);

...
public class Tcproject extends BaseModel {
	...
	public static final String ALIAS_PNEED_WARMUP="是否有预热期";
	...
	private List<SysFile> tPPic;
	private List<Long> tPPicIds;
	...
	public List<Long> getFileIdList() {
		if (StringUtil.isEmpty(ppic)) {
			return null;
		}
		if ( null != tPPicIds ) {
			return tPPicIds;
		}
		tPPicIds = SysFileHelper.getFileIdsFromPPic(ppic);
		return tPPicIds;
	}
	...
	public int getPneedWarmUp(){return pneedWarmUp; }

	public void setPneedWarmUp(int needWarmUp){this.pneedWarmUp = needWarmUp;}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("PneedWarmUp",pneedWarmUp)

...
public class QueryValidatorServicesService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(com.deelon.crowdfunding.webservice.client.cardValidate.QueryValidatorServicesService.class
					.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = com.deelon.crowdfunding.webservice.client.cardValidate.QueryValidatorServicesService.class
					.getResource(".");
			url = new URL(baseUrl,

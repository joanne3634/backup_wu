...
<script type="text/javascript" src="${ctx }/js/deelon/platform/bpm/SetRelationWindow.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/ImportExportXmlUtil.js" charset="UTF-8"></script>
...
<body>
	<div class="panel">
		...
		<div class="panel-body">
			...
			<deelon:paging tableId="bpmFormTableItem" />
		</div>
		<!-- end of panel-body -->
	</div>
	<!-- end of panel -->

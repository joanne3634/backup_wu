				...
				<form id="dictionaryForm" method="post" action="save.ht">
					<table border="0" cellspacing="0" cellpadding="0" class="table-detail">
						<tr>
							...
							<td ><input  style="width: 200px;" type="text" id="itemName" name="itemName" value="${dictionary.itemName}" 
							 class="inputText"/></td><!-- onblur="autoGetDictionaryKey(this)" -->
						</tr>	
						<tr>
							<th width="20%">关键字:</th>
							<td ><input  style="width: 200px;" type="text" id="itemKey" name="itemKey" value="${dictionary.itemKey}" class="inputText"/>
							<br>
							可为空,如果填写的话,在该数据字典中必须唯一。</td>
						</tr>				
						<tr>
							<th width="20%">项值:<span class="required">*</span></th>
							<td ><input  style="width: 200px;" type="text" id="itemValue" name="itemValue" value="${dictionary.itemValue}"   class="inputText"  /></td>
						</tr>
						<tr>
							<th width="20%">说明:</th>
							<td ><textarea type="text" id="descp" name="descp"  rows="5" cols="3"   class="inputText"  >${dictionary.descp}</textarea></td>
						</tr>
					</table>

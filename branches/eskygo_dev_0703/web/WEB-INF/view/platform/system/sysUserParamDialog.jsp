<%@ page language="java" contentType="text/html; charset=UTF-8" import="com.deelon.platform.model.system.SysParam"
    pageEncoding="UTF-8"%>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/ConditionExpression.js"></script>

...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.deelon.platform.model.system.SysParam"%>
...
<body>
			...
			<div class="hide-panel">
				...
				<div class="panel-body">
						...
						<deelon:paging tableId="sysParamItem"/>

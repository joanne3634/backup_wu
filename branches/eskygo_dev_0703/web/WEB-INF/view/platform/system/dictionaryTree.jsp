<%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8" import="com.deelon.platform.model.system.GlobalType"%>
...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/deelon/platform/form/GlobalType.js"></script>
	<script type="text/javascript" src="${ctx}/js/deelon/platform/system/GlobalMenu.js"></script>
	<script type="text/javascript">
		...
		*/
		...
		function editDict(){
			...
			var winArgs="dialogWidth=450px;dialogHeight=260px;help=no;status=no;scroll=no;center=yes";
	...
	<style type="text/css">
		...
		html,body{ padding:0px; margin:0; width:100%;height:100%;overflow-x: hidden;}
	</style>
</head>
<body>
<div id="layout">

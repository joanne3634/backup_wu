...
<script type="text/javascript" src="${ctx}/js/deelon/platform/bus/BusQueryRuleUtil.js" ></script>
</head>
<body>
	<div class="panel">
		<div class="panel-top">
				...
				<form id="searchForm" method="post" action="list.ht">
					<ul class="row">
						<li>
							...
							<input type="text" name="Q_tableName_SL"  class="inputText" value="${param['Q_tableName_SL']}" />
						</li>
						<li>
							<span class="label">注释:</span>
							<input type="text" name="Q_comment_SL"  class="inputText" value="${param['Q_comment_SL']}"/>
						</li>
						</li>
					</ul>
				</form>
		...
		<div class="panel-body">
		    ...
		    <display:table name="tableEntityList" id="tableEntityItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
				...
				<deelon:paging tableId="tableEntityItem"/>

...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/ProcessUrgeDialog.js"></script>
	...
	<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/CheckVersion.js"></script>
	<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/SelectUtil.js" ></script>
      ...
      <div class="hide-panel">
       	<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
						<c:if test="${isCanRedo or (param.prePage ==\"myRequest\")}">

<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.deelon.platform.model.bpm.BpmDefRights"%>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/ImportExportXmlUtil.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/tabOperator.js" ></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/FlowRightDialog.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/FlowUtil.js" ></script>
...
<body>      
	...
	<div class="panel-top">	
		...
		<div class="panel-body">
				...
				<deelon:paging tableId="bpmDefinitionItem"/>

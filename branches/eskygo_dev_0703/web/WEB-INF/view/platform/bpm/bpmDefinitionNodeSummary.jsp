    ...
    <title>节点概要</title>
       <%@include file="/commons/include/form.jsp" %>  
        ...
        <script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/FlowReminderWindow.js" ></script>
   		<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/BpmNodeButtonWindow.js" ></script>
   		<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/BpmNodeUserSetWindow.js" ></script>

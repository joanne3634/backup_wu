...
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/TaskCommentWindow.js" ></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/bpm/TaskDetailWindow.js"></script>

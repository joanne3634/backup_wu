	...
	<div class="window">
		...
		<h3><img src="${ctx }/crowdfunding/Skin/Default/images/toptriangle.png">融资金额及进度</h3>
			...
			<div class="plantext">
				<h5>最低投资金额</h5>
				<span>
					<fmt:formatNumber value="${tcproject.pinvestMinFollow/10000}" pattern="###,###"   minFractionDigits="0" />万
				</span>
			</div>
			...
			<!--<div class="planButton">
				<ul>
					...
					<li class="yuetan" onclick="aboutEntrepre('${collectProjectInfo.creator}','${collectProjectInfo.projectId}');"><img src="${ctx }/crowdfunding/Skin/Default/images/InPrIcont3.png">约谈项目方</li>
	...
	/* 	$(".InIfgoto").click(function(){
		...
		$(".yuetan").click(function(){
		    ...
		    <c:if test="${TUser.groupId eq 1 }">
				   openDialog("<div class=\"_warning\">对不起， 项目方不能向别的项目发起约谈!</div>",'40%','25%','3');
				return;
			</c:if>
			<c:if test="${ not empty TUser }">

    ...
    <div class="column-group horizontal-gutters">
        ...
        <div class="all-100">
            <div class="register-container push-center">
                <h4 class="title">以下信息均为必填项，请完整填写！(<a href="${ctx }/user/registerInit.ht?type=3">投资方快速注册...</a>)</h4>
                ...
                <form action="${ctx}/user/register.ht" method="post" id="registerForm" class="ink-form">
                    <fieldset>
                        ...
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="text" name="loginName" id="loginName" data-rules="required|min_length[3]|max_length[20]" >
                            </div>
                        </div>
                        <div class="control-group required gutters">
                            <label for="email" class="all-20 align-right">邮箱：</label>
                            <div class="control all-80">
                                <input type="email" name="email" id="email" data-rules="required|email">
                            </div>
                        </div>
                        <div class="control-group required gutters">
                            <label for="remarks" class="all-20 align-right">个人说明：</label>
                            <div class="control all-80">
                                <input type="text" name="remarks" id="remarks" data-rules="required">
                        ...
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="password" name="loginPwd" id="loginPwd" data-rules="required|min_length[6]|max_length[20]|regexNumeric|regexAlpha" onKeyUp="pwStrength(this.value)" onBlur="pwStrength(this.value)">
                        ...
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="password" name="resloginPwd" id="resloginPwd" data-rules="required|matches[loginPwd]">
                            </div>
                        </div>
                        <div class="control-group required gutters">
                            <label for="realName" class="all-20 align-right">真实姓名：</label>
                            <div class="control all-80">
                                <input type="text" name="realName" id="realName" data-rules="required">
                                <input type="text" name="contactName" id="contactName" data-rules="required" style="display: none;" disabled>
                        ...
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="text" name="idNo" id="idNo" data-rules="required|idCard">
                                <input type="text" name="businessLicense" id="businessLicense" data-rules="required" style="display: none;" disabled>
                                <p class="help-block">用于网站运营管理人员替您办理投融资手续时使用</p>
                            </div>
                        </div>
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="text" name="personalAddress" id="personalAddress" data-rules="required">
                        ...
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="text" name="mobile" id="mobile" maxlength="11" data-rules="required|mobile">
                                <p class="help-block">用于网站运营管理人员替您办理投融资手续时使用</p>
                            </div>
                        </div>
                        <div class="control-group required gutters">
                            ...
                            <div class="control all-80">
                                <input type="text" name="code" id="code" maxlength="4" data-rules="required" onkeyup="valideCode();"style="width:15%">
                        ...
                        <div id="msgcodeDiv" class="control-group required gutters" style="display:none">
							 ...
							 <div class="control all-80">
							 	<input type="text" name="msgcode" id="msgcode" maxlength="6" data-rules="required" style="width:15%">

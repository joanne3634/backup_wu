...
<div class="clear recordAll">
<a href="javascript:void(0);" onclick="toProdetailsPage('${ctx }/crowdfunding/front/toProCommentAll.ht?projectId=${projectId }')" 
>>>更多评论</a>
</div>

...
<%
	String afterId =RequestUtil.getString(request, "afterId") ; // 附件分类编号
...
<html>
  ...
  <style type="text/css"> 
	...
	#flashContent { display:none; }
       ...
       var uploadPath="${ctx}/crowdfunding/tcprojectAfter/projectAfterFileUpload.ht;jsessionid=<%=session.getId()%>?projectId=${projectId}&afterId=${afterId}";
       var delPath="${ctx}/crowdfunding/tcprojectAfter/projectAfterAttachDel.ht;jsessionid=<%=session.getId()%>" ;

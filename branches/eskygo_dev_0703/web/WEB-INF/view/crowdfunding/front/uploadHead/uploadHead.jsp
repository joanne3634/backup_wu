...
function picCallBack(fileIds, array) {
	...
	var path = __ctx + "/wuyouchou/system/sysFile/getFileById.ht?fileId="+ fileId;
	 if((/\.(png|gif|jpe?g)$/i).test(fileName)){
		...
		openDialog("请选择*png,*gif,*jpg类型图片!");
		return;
	}
			...
			<div class="ModifyPicture">
				...
				<div class="MoPiRight f_l">
						<c:if test="${empty user.myPhoto }">
							<div><img src="${ctx }/crowdfunding/resources/img/head_blank.png" id="MoPiRightImg1"></div>头像100 x 100
							<div><img src="${ctx }/crowdfunding/resources/img/head_blank.png" id="MoPiRightImg2"></div>头像90 x 90
							<div><img src="${ctx }/crowdfunding/resources/img/head_blank.png" id="MoPiRightImg3"></div>头像45 x 45
							<div><img src="${ctx }/crowdfunding/resources/img/head_blank.png" id="MoPiRightImg4"></div>头像30 x 30
						</c:if>

...
$().ready(function() {
	 $("#changeTradingPwd_form").validate({
	        rules: {
	        beforePwd: {//原密码验证
	    	    required: true,
	  		    minlength: 6,
		 ...
		 $("#BtnSave").click(function(){
			...
			if($('#changeTradingPwd_form').valid()){	
				$.ajax({
					url : "${ctx}/crowdfunding/tcuserPersonalData/changeAccountTradingPwd.ht",
					type : 'post',
					data : $('#changeTradingPwd_form').serialize(),
					dataType : 'json',
					success : function(data) {
						window.parent.openDialog(data);
						setTimeout('window.location = "${ctx}/crowdfunding/tcuserPersonalData/changeAccountTradingPwdPage.ht";',2000);
					},
...
<body>
		<div class="addyourproject f_l">
			<h2><img src="${ctx }/crowdfunding/Skin/Default/images/headportrait4.png">修改交易密码</h2>

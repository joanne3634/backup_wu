...
//							minlength: 5,
				...
				if($('#TmoneyMoveForm').valid()){
					$.ajax({
						url : "${ctx}/crowdfunding/backstage/userinvest/toPayASKMoney.ht",
						type : 'post',
						...
						success : function(data) {
							if(data.result==1){
								$.ligerDialog.alertExt("数据操作成功","提示信息",function(rtn){
									if(rtn){
										location.href="${ctx}/crowdfunding/tcuser/tcuser/investorASKList.ht?groupId=2";
									}
									else{
										location.href="#";
									}
		...
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link back" href="${ctx}/crowdfunding/tcuser/tcuser/investorASKList.ht?groupId=2"><span></span>返回</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body" style="margin-top: 1px">
		<form id="TmoneyMoveForm" method="post" action="${ctx}/crowdfunding/backstage/userinvest/toPayASKMoney.ht">

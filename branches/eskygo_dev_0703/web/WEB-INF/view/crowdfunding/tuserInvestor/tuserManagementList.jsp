				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="tuserList" id="tuserItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column property="mobile" title="手机号码" sortable="false" sortName="Mobile" style="text-align:center"/>  
...
<%-- 							</display:column>   --%>
							<display:column property="email" title="邮箱" sortable="false" sortName="Mobile" style="text-align:center"/>  
							<display:column title="最后登录时间" sortable="false" sortName="LastLoginTime" style="text-align:center">
...
<%-- 							<display:column title="所在城市" sortable="false" style="text-align:center">  --%>
<%-- 								<f:description modelCode="t_area" modelSqlKey="getById" modelPropertyName="areaName" modelPropertyValue="areaId" nodeKey="MODEL_DATA"  itemValue="${tuserItem.cityId }"/> --%>
<%-- 							</display:column>  --%>
...
<%-- 							</display:column>   --%>
<%-- 							<display:column property="contactName" title="联系人" sortable="false" sortName="contactName" style="text-align:center"/>  --%>
<%-- 							<display:column property="isDel" title="删除" sortable="false" sortName="isDel" style="text-align:center"/>  --%>

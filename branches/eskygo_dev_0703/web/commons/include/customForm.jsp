...
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/rule.js"></script>

<script type="text/javascript" src="${ctx}/js/deelon/CustomValid.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/CustomForm.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/FlexUploadDialog.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/AttachMent.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/SubtablePermission.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/ReadOnlyQuery.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/OfficeControl.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/OfficePlugin.js"></script>
...
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/FormMath.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/FormUtil.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/ShowExeInfo.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/SysAuditLink.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/Cascadequery.js"></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/system/ImageQtip.js" ></script>
<script type="text/javascript" src="${ctx}/js/deelon/platform/form/FormInit.js"></script>